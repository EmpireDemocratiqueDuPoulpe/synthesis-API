...
function startServer() {
	...
	expressJSDocSwagger(app)({ ...Swagger, baseDir: currentFile.__dirname });
	...
	// Serves static files
	app.use("/.well-known", express.static(path.join(currentFile.__dirname, "./.well-known"), { dotfiles: "allow" }));
	app.use("/files", express.static(path.join(currentFile.__dirname, "./uploads")));
