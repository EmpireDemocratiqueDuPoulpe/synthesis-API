	...
	*/
	...
	await sequelize.models.user.bulkCreate([
		// Admin. plateforme
		{
			...
			address_street: "This is my street.",
			address_city: "London",
			address_postal_code: "45789",
			gender: "homme",
			region: "UK",
		},
		// Direction académique
		{
			user_id: 1001, position_id: 2, campus_id: 1003,
			first_name: "Pony", last_name: "Sparks",
			birth_date: "1976-04-06",
			email: "pony.sparks@weapo.ns",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Under the bridge",
			address_city: "NY",
		...
		// Administration
		{
			user_id: 1002, position_id: 3, campus_id: 1001,
			first_name: "Nem", last_name: "Ô",
			birth_date: "2003-11-26",
			email: "nem.o@fi.sh",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Anémone n°457",
			address_city: "Océan",
			address_postal_code: "bloup",
			gender: "homme",
			region: "Atlantique",
		},
		// Pédagogie
		{
			user_id: 1003, position_id: 4, campus_id: 1004,
			first_name: "Gorge W.", last_name: "Bouche",
			birth_date: "1946-07-06",
			email: "gorge.w@bouc.he",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "États-Unis du Corps",
			address_city: "Tête",
		...
		// Intervenant
		{
			user_id: 1004, position_id: 5, campus_id: 1003,
			first_name: "Space", last_name: "Odin",
			birth_date: "0001-01-01",
			email: "space.odin@spacesh.ip",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Andromeda",
			address_city: "X4s-GA5",
			address_postal_code: "3,1415",
			gender: "homme",
			region: "Espace de la confédération galactique",
		},
		// Étudiant
		{
			user_id: 1005, position_id: 6, campus_id: 1001,
			first_name: "Jay", last_name: "Raté Mon Année À L'Aide",
			birth_date: "2002-06-24",
			email: "jay.rate@forni.te",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Tomato Plaza",
			address_city: "Map de frotnite",
			address_postal_code: "0000",
			gender: "homme",
			region: "France",
		},
		{
			user_id: 1006, position_id: 6, campus_id: 1004,
			first_name: "Johnny", last_name: "Hotbody",
			birth_date: "2019-01-29",
			email: "johnny.hotbody@bodylan.de",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Absville",
			address_city: "Bodylande",
			address_postal_code: "12345",
			gender: "homme",
			region: "US",
		},
		{
			user_id: 1007, position_id: 6, campus_id: 1005,
			first_name: "yo", last_name: "mom",
			birth_date: "0001-01-01",
			email: "yo.mom@so.fat",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Yo mom so fat",
			address_city: "She's a black hole",
			address_postal_code: "(haha)",
			gender: "femme",
			region: "US",
		},
	]);
	...
	await sequelize.models.userModules.bulkCreate([
		...
		{ user_id: 1005, module_id: 1001 },
		{ user_id: 1005, module_id: 1002 },
		{ user_id: 1005, module_id: 1003 },
		{ user_id: 1005, module_id: 1004 },
		{ user_id: 1005, module_id: 1005 },
		{ user_id: 1006, module_id: 1018 },
		{ user_id: 1006, module_id: 1019 },
		{ user_id: 1006, module_id: 1020 },
		{ user_id: 1005, module_id: 1021 },
		{ user_id: 1005, module_id: 1022 },
		{ user_id: 1005, module_id: 1023 },
		{ user_id: 1007, module_id: 1007 },
		{ user_id: 1007, module_id: 1008 },
		{ user_id: 1007, module_id: 1009 },
		{ user_id: 1007, module_id: 1010 },
		{ user_id: 1004, module_id: 1000 },
		{ user_id: 1004, module_id: 1005 },
		{ user_id: 1004, module_id: 1010 },
	]);
	...
	await sequelize.models.note.bulkCreate([
		{ user_id: 1005, module_id: 1000, note: 14.5 },
		{ user_id: 1005, module_id: 1001, note: 14.5 },
		{ user_id: 1005, module_id: 1002, note: 14.5 },
		{ user_id: 1005, module_id: 1003, note: 14.5 },
		{ user_id: 1005, module_id: 1004, note: 8 },
		{ user_id: 1005, module_id: 1005, note: 14.5 },
		{ user_id: 1005, module_id: 1006, note: 14.5 },
		{ user_id: 1005, module_id: 1007, note: 14.5 },
		{ user_id: 1005, module_id: 1008, note: 0.1 },
		{ user_id: 1005, module_id: 1009, note: 14.5 },
		{ user_id: 1005, module_id: 1010, note: 14.5 },
		{ user_id: 1005, module_id: 1011, note: 14.5 },
		{ user_id: 1005, module_id: 1012, note: 14.5 },
		{ user_id: 1005, module_id: 1013, note: 14.5 },
		{ user_id: 1005, module_id: 1014, note: 14.5 },
		{ user_id: 1005, module_id: 1015, note: 14.5 },
		{ user_id: 1005, module_id: 1016, note: 14.5 },
		{ user_id: 1005, module_id: 1017, note: 14.5 },
		{ user_id: 1005, module_id: 1018, note: 14.5 },
		{ user_id: 1005, module_id: 1019, note: 14.5 },
		{ user_id: 1005, module_id: 1020, note: 14.5 },
		{ user_id: 1006, module_id: 1000, note: 14.5 },
		{ user_id: 1006, module_id: 1001, note: 14.5 },
		{ user_id: 1006, module_id: 1002, note: 14.5 },
		{ user_id: 1000, module_id: 1003, note: 14.5 },
		{ user_id: 1000, module_id: 1004, note: 14.5 },
		{ user_id: 1006, module_id: 1005, note: 14.5 },
		{ user_id: 1000, module_id: 1006, note: 14.5 },
		{ user_id: 1006, module_id: 1007, note: 14.5 },
		{ user_id: 1006, module_id: 1008, note: 14.5 },
		{ user_id: 1006, module_id: 1009, note: 14.5 },
		{ user_id: 1006, module_id: 1010, note: 14.5 },
		{ user_id: 1000, module_id: 1011, note: 14.5 },
		{ user_id: 1000, module_id: 1012, note: 14.5 },
		{ user_id: 1006, module_id: 1013, note: 14.5 },
		{ user_id: 1000, module_id: 1014, note: 14.5 },
		{ user_id: 1006, module_id: 1015, note: 14.5 },
		{ user_id: 1000, module_id: 1016, note: 14.5 },
		{ user_id: 1000, module_id: 1017, note: 14.5 },
		{ user_id: 1006, module_id: 1018, note: 14.5 },
