...
produits vendus en magasin.`,
	...
	await sequelize.models.user.bulkCreate([
		// Admin. plateforme
		{
			...
			first_name: "Sir Edward", last_name: "Lionheart",
			birth_date: "968-06-24", gender: "homme",
			email: "siredward.lionheart@supinfo.com",
		...
		// Direction académique
		{
			...
			email: "tony.stark@supinfo.com",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Under the bridge", address_city: "NY", address_postal_code: "12496",
			region: "US",
		},
		// Administration
		{
			...
			email: "nem.o@supinfo.com", gender: "homme",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Anémone n°457", address_city: "Océan", address_postal_code: "87563",
			region: "Atlantique",
		},
		// Pédagogie
		{
			...
			email: "gorge.w.bouche@supinfo.com",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "États-Unis du Corps", address_city: "Tête", address_postal_code: "14560",
			region: "Maestro Secret Room",
		},
		// Intervenant
		{
			user_id: 10004, position_id: 5, campus_id: 10003,
			first_name: "Stéphane", last_name: "Odin",
			birth_date: "0001-01-01", gender: "homme",
			email: "stephane.odin@supinfo.com",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Andromeda", address_city: "X4s-GA5", address_postal_code: "75000",
			region: "Espace de la confédération galactique",
		},
		// Étudiant
		{
			user_id: 10005, position_id: 6, campus_id: 10002,
			first_name: "Peter", last_name: "Jay",
			birth_date: "2002-06-24", gender: "homme",
			email: "peter.jay@supinfo.com",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Tomato Plaza", address_city: "Delphino Island", address_postal_code: "59860",
			region: "France",
		},
		{
			user_id: 10006, position_id: 6, campus_id: 10004,
			first_name: "Johnny", last_name: "Eastwood",
			birth_date: "2019-01-29", gender: "homme",
			email: "johnny.eastwood@supinfo.com",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "Absville", address_city: "Bodylande", address_postal_code: "17965",
			region: "US",
		},
		{
			user_id: 10007, position_id: 6, campus_id: 10005,
			first_name: "Bob", last_name: "Square",
			birth_date: "0001-01-01", gender: "femme",
			email: "bob.square@supinfo.com",
			password: "$2b$10$sbcqNmQi3DoIDQG1zbB9degN.toQN4hn2T562.yubcPvDra/RT46.", // "Mot De P4sse"
			address_street: "59² rue des Phalempins", address_city: "Detroit", address_postal_code: "94623",
			region: "US",
		},
	]);
	...
	await sequelize.models.planning.bulkCreate([
		{
			...
			start_date: "06/09/22 10:00:00",
			end_date: "06/09/22 12:00:00",
		...
		},
		{
			...
			start_date: "01/19/22 9:00:00",
			end_date: "01/19/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10029, module_id: 10022, campus_id: 10000,
			start_date: "01/20/22 9:00:00",
			end_date: "01/20/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10030, module_id: 10022, campus_id: 10000,
			start_date: "01/21/22 9:00:00",
			end_date: "01/21/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10005, module_id: 10012, campus_id: 10004,
			start_date: "09/14/22 9:00:00",
			end_date: "09/14/22 17:00:00",
			event_name: "", event_type: "module",
			year: 4,
		},
		{
			planning_id: 10031, module_id: 10012, campus_id: 10004,
			start_date: "09/15/22 9:00:00",
			end_date: "09/15/22 17:00:00",
			event_name: "", event_type: "module",
			year: 4,
		},
		{
			planning_id: 10032, module_id: 10012, campus_id: 10004,
			start_date: "09/16/22 9:00:00",
			end_date: "09/16/22 17:00:00",
			event_name: "", event_type: "module",
			year: 4,
		},
		{
		...
		{
			planning_id: 10033, module_id: 10023, campus_id: 10002,
			start_date: "11/29/22 9:00:00",
			end_date: "11/29/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10034, module_id: 10023, campus_id: 10002,
			start_date: "11/30/22 9:00:00",
			end_date: "11/30/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10035, module_id: 10023, campus_id: 10002,
			start_date: "12/01/22 9:00:00",
			end_date: "12/01/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10007, module_id: 10029, campus_id: 10003,
			start_date: "06/06/22 9:00:00",
			end_date: "06/06/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10036, module_id: 10029, campus_id: 10003,
			start_date: "06/07/22 9:00:00",
			end_date: "06/07/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10037, module_id: 10029, campus_id: 10003,
			start_date: "06/08/22 9:00:00",
			end_date: "06/08/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
		...
		},
		{
			...
			start_date: "12/13/22 9:00:00",
			end_date: "12/13/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			planning_id: 10100, module_id: 10004, campus_id: 10000,
			start_date: "12/14/22 9:00:00",
			end_date: "12/14/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			planning_id: 10101, module_id: 10004, campus_id: 10000,
			start_date: "12/15/22 9:00:00",
			end_date: "12/15/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			planning_id: 10010, module_id: 10006, campus_id: 10005,
			start_date: "04/19/22 9:00:00",
			end_date: "04/19/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			planning_id: 10102, module_id: 10006, campus_id: 10005,
			start_date: "04/20/22 9:00:00",
			end_date: "04/20/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			planning_id: 10011, module_id: 10023, campus_id: 10001,
			start_date: "02/08/22 9:00:00",
			end_date: "02/08/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10103, module_id: 10023, campus_id: 10001,
			start_date: "02/09/22 9:00:00",
			end_date: "02/09/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10104, module_id: 10023, campus_id: 10001,
			start_date: "02/10/22 9:00:00",
			end_date: "02/10/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10105, module_id: 10023, campus_id: 10001,
			start_date: "02/11/22 9:00:00",
			end_date: "02/11/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10012, module_id: 10030, campus_id: 10001,
			start_date: "05/24/22 9:00:00",
			end_date: "05/24/22 17:00:00",
			event_name: "", event_type: "module",
			year: 4,
		},
		{
			planning_id: 10013, module_id: 10007, campus_id: 10002,
			start_date: "02/07/22 9:00:00",
			end_date: "02/07/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10107, module_id: 10007, campus_id: 10002,
			start_date: "02/08/22 9:00:00",
			end_date: "02/08/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		...
		{
			planning_id: 10106, module_id: 10007, campus_id: 10002,
			start_date: "02/09/22 9:00:00",
			end_date: "02/09/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			...
			start_date: "10/18/22 9:00:00",
			end_date: "10/18/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10180, module_id: 10028, campus_id: 10000,
			start_date: "10/19/22 9:00:00",
			end_date: "10/19/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10108, module_id: 10028, campus_id: 10000,
			start_date: "10/20/22 9:00:00",
			end_date: "10/20/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10015, module_id: 10007, campus_id: 10002,
			start_date: "09/26/22 9:00:00",
			end_date: "09/26/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10109, module_id: 10007, campus_id: 10002,
			start_date: "09/27/22 9:00:00",
			end_date: "09/27/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			...
			end_date: "12/12/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			planning_id: 10150, module_id: 10020, campus_id: 10001,
			start_date: "12/13/22 9:00:00",
			end_date: "12/13/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		...
		{
			planning_id: 10151, module_id: 10018, campus_id: 10001,
			start_date: "01/03/22 9:00:00",
			end_date: "01/03/22 17:00:00",
			event_name: "", event_type: "module",
			year: 4,
		},
		{
			planning_id: 10152, module_id: 10018, campus_id: 10001,
			start_date: "01/04/22 9:00:00",
			end_date: "01/04/22 17:00:00",
			event_name: "", event_type: "module",
			year: 4,
		},
		{
			planning_id: 10019, module_id: 10017, campus_id: 10000,
			start_date: "05/09/22 9:00:00",
			end_date: "05/09/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10154, module_id: 10017, campus_id: 10000,
			start_date: "05/10/22 9:00:00",
			end_date: "05/10/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10020, module_id: 10016, campus_id: 10005,
			start_date: "03/08/22 9:00:00",
			end_date: "03/08/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10021, module_id: 10010, campus_id: 10003,
			start_date: "10/06/22 9:00:00",
			end_date: "10/06/22 17:00:00",
			event_name: "", event_type: "module",
			year: 4,
		},
		{
			planning_id: 10181, module_id: 10010, campus_id: 10003,
			start_date: "10/07/22 9:00:00",
			end_date: "10/07/22 17:00:00",
			event_name: "", event_type: "module",
			year: 4,
		},
		{
			planning_id: 10022, module_id: 10005, campus_id: 10002,
			start_date: "12/05/22 9:00:00",
			end_date: "12/05/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10156, module_id: 10005, campus_id: 10002,
			start_date: "12/06/22 9:00:00",
			end_date: "12/06/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10155, module_id: 10005, campus_id: 10002,
			start_date: "12/07/22 9:00:00",
			end_date: "12/07/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10023, module_id: 10019, campus_id: 10004,
			start_date: "06/21/22 9:00:00",
			end_date: "06/21/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10157, module_id: 10019, campus_id: 10004,
			start_date: "06/22/22 9:00:00",
			end_date: "06/22/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10024, module_id: 10019, campus_id: 10001,
			start_date: "04/25/22 9:00:00",
			end_date: "04/25/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			...
			end_date: "11/21/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10158, module_id: 10020, campus_id: 10003,
			start_date: "11/22/22 9:00:00",
			end_date: "11/22/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10159, module_id: 10020, campus_id: 10003,
			start_date: "11/23/22 9:00:00",
			end_date: "11/23/22 17:00:00",
			event_name: "", event_type: "module",
			year: 5,
		},
		{
			planning_id: 10026, module_id: 10012, campus_id: 10002,
			start_date: "09/19/22 9:00:00",
			end_date: "09/19/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10160, module_id: 10012, campus_id: 10002,
			start_date: "09/20/22 9:00:00",
			end_date: "09/20/22 17:00:00",
			event_name: "", event_type: "module",
			year: 1,
		},
		{
			planning_id: 10027, module_id: 10006, campus_id: 10005,
			start_date: "06/23/22 9:00:00",
			end_date: "06/23/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			planning_id: 10161, module_id: 10006, campus_id: 10005,
			start_date: "06/24/22 9:00:00",
			end_date: "06/24/22 17:00:00",
			event_name: "", event_type: "module",
			year: 2,
		},
		{
			planning_id: 10028, module_id: 10006, campus_id: 10002,
			start_date: "06/09/22 9:00:00",
			end_date: "06/09/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
		{
			planning_id: 10162, module_id: 10006, campus_id: 10002,
			start_date: "06/10/22 9:00:00",
			end_date: "06/10/22 17:00:00",
			event_name: "", event_type: "module",
			year: 3,
		},
	]);
